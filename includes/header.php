...
<body style="
  ...
  <header>
    <nav class="navbar navbar-expand navbar-dark bg-dark">
      <a class="navbar-brand" href="http://localhost/rossi/crud/index.php">
        ...
        DEMO Crud de Usuarios y Notas Personales
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto">
          <?php if (isset($_SESSION['user'])) { ?>
            <li class="nav-item">
              <a class="nav-link" href="../controllers/controllerLogout.php">Logout </a>
            </li>
          <?php } else { ?>
            <li class="nav-item">
